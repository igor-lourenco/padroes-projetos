package com.categoria.comportamentais._1_observer._1_depois.notificador;

import com.categoria.comportamentais._1_observer._1_depois.model.Lancamento;
import com.categoria.comportamentais._1_observer._1_depois.ouvintes.Ouvinte;
...
public class LancamentosVencidosNotificador implements Notificador {
    ...
    public void notificarOuvintes() {
        ...
        ouvintes.forEach(ouvinte -> ouvinte.atualizar(this.lancamentosVencidos));
    }
